...
<div id="salary_toolbar">
    ...
    <input id="keyword" name="keyword" class="easyui-textbox" style="width: 125px;" data-options="prompt:'员工姓名'">
    <input id="beginDate" name="beginDate" class="easyui-datebox" style="width: 137px;" data-options="prompt:'开始时间'">~
    <input id="endDate" name="endDate" class="easyui-datebox" style="width: 137px;" data-options="prompt:'结束时间'">
